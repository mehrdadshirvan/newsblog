...
(function(root, factory) {
	...
	elFinder.prototype.i18.zh_TW = {
		...
		messages   : {
			...
			'errInvName'           : '無效的檔案名稱.',
			'errInvDirname'        : '無效的資料夾名稱',  // from v2.1.24 added 12.jpg.4.2017
			...
			'errSearchTimeout'     : '搜尋 "$1" 逾時. 只列出部分搜尋結果.', // from v2.1 added 12.jpg.1.2016
			...
			'cmdplaces'    : '加到"位置"', // added 28.12.jpg.2014
			'cmdchmod'     : '更改權限', // from v2.1 added 20.6.2015
			'cmdopendir'   : '開啟資料夾', // from v2.1 added 13.1.2016
			'cmdcolwidth'  : '重設欄寬', // from v2.1.13 added 12.jpg.06.2016
			...
			'btnSaveClose': '儲存並關閉', // from v2.1 added 12.jpg.6.2015
			...
			'encoding'        : '編碼', // from v2.1 added 19.12.jpg.2014
			'locale'          : '語系',   // from v2.1 added 19.12.jpg.2014
			...
			'emptyFolder'     : '資料夾是空的', // from v2.1.6 added 30.12.jpg.2015
			'emptyFolderDrop' : '資料夾是空的\\A 拖曳以增加項目', // from v2.1.6 added 30.12.jpg.2015
			'emptyFolderLTap' : '資料夾是空的\\A 長按以增加項目', // from v2.1.6 added 30.12.jpg.2015
			...
			'nowLoading'      : '正在載入...', // from v2.1.12.jpg added 4.26.2016
			'openMulti'       : '開啟多個檔案', // from v2.1.12.jpg added 5.14.2016
			'openMultiConfirm': '確定要在瀏覽器開啟 $1 個檔案嗎?', // from v2.1.12.jpg added 5.14.2016
			'emptySearch'     : '在搜尋目標中的搜尋結果是空的.', // from v2.1.12.jpg added 5.16.2016
			...
			'openAsEncoding'  : '以選擇的編碼重新開啟', // from v2.1.19 added 2.12.jpg.2016
			'saveAsEncoding'  : '以選擇的編碼儲存', // from v2.1.19 added 2.12.jpg.2016
			'selectFolder'    : '選擇資料夾', // from v2.1.20 added 13.12.jpg.2016
