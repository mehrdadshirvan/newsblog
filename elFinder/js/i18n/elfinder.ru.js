...
(function(root, factory) {
	...
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'errInvDirname'        : 'Недопустимое имя папки.',  // from v2.1.24 added 12.jpg.4.2017
			...
			'errSearchTimeout'     : 'Превышено время ожидания при поиске "$1". Результаты поиска частичные.', // from v2.1 added 12.jpg.1.2016
			...
			'cmdplaces'    : 'В избранное', // added 28.12.jpg.2014
			'cmdchmod'     : 'Изменить права доступа', // from v2.1 added 20.6.2015
			'cmdopendir'   : 'Открыть папку', // from v2.1 added 13.1.2016
			'cmdcolwidth'  : 'Сбросить ширину колонок', // from v2.1.13 added 12.jpg.06.2016
			...
			'btnSaveClose': 'Сохранить и закрыть', // from v2.1 added 12.jpg.6.2015
			...
			'encoding'        : 'Кодировка', // from v2.1 added 19.12.jpg.2014
			'locale'          : 'Локаль',   // from v2.1 added 19.12.jpg.2014
			...
			'emptyFolder'     : 'Папка пуста', // from v2.1.6 added 30.12.jpg.2015
			'emptyFolderDrop' : 'Папка пуста\\A Перетащите чтобы добавить', // from v2.1.6 added 30.12.jpg.2015
			'emptyFolderLTap' : 'Папка пуста\\A Долгое нажатие чтобы добавить', // from v2.1.6 added 30.12.jpg.2015
			...
			'nowLoading'      : 'Загружается...', // from v2.1.12.jpg added 4.26.2016
			'openMulti'       : 'Открыть несколько файлов', // from v2.1.12.jpg added 5.14.2016
			'openMultiConfirm': 'Вы пытаетесь открыть $1 файл(а/ов). Вы уверены, что хотите открыть их в браузере?', // from v2.1.12.jpg added 5.14.2016
			'emptySearch'     : 'Ничего не найдено', // from v2.1.12.jpg added 5.16.2016
			...
			'openAsEncoding'  : 'Переоткрыть с выбранной кодировкой', // from v2.1.19 added 2.12.jpg.2016
			'saveAsEncoding'  : 'Сохранить с выбранной кодировкой', // from v2.1.19 added 2.12.jpg.2016
			'selectFolder'    : 'Выбрать папку', // from v2.1.20 added 13.12.jpg.2016
			...
			'renameMultiple'  : 'Переименовать выбранные элементы ($1 шт.) в $2?<br/>Действие нельзя отменить!', // from v2.1.31 added 4.12.jpg.2017
			'batchRename'     : 'Групповое переименование', // from v2.1.31 added 8.12.jpg.2017
			'plusNumber'      : '+ Число', // from v2.1.31 added 8.12.jpg.2017
			'asPrefix'        : 'Добавить префикс', // from v2.1.31 added 8.12.jpg.2017
			'asSuffix'        : 'Добавить суффикс', // from v2.1.31 added 8.12.jpg.2017
			'changeExtention' : 'Изменить расширение', // from v2.1.31 added 8.12.jpg.2017
			...
			'exportToSave'    : 'Невозможно сохранить файл. Чтобы не потерять изменения, экспортируйте их на свой ПК.', // from v2.1.44 added 1.12.jpg.2018
