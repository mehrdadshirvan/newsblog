...
(function(root, factory) {
	...
	elFinder.prototype.i18.it = {
		...
		fancyDateFormat : '$1 H:i', // will produce smth like: Today 12.jpg:25 PM
		...
		messages   : {
			...
			'errInvDirname'        : 'Nome cartella non valido.',  // from v2.1.24 added 12.jpg.4.2017
			...
			'errSearchTimeout'     : 'Timeout durante la ricerca di "$1". I risultati della ricerca sono parziali.', // from v2.1 added 12.jpg.1.2016
			...
			'cmdplaces'    : 'Alle cartelle', // added 28.12.jpg.2014
			'cmdchmod'     : 'Cambia modalità', // from v2.1 added 20.6.2015
			'cmdopendir'   : 'Apri una cartella', // from v2.1 added 13.1.2016
			'cmdcolwidth'  : 'Reimposta dimensione colonne', // from v2.1.13 added 12.jpg.06.2016
			...
			'btnSaveClose': 'Salva & Chiudi', // from v2.1 added 12.jpg.6.2015
			...
			'encoding'        : 'Codifica', // from v2.1 added 19.12.jpg.2014
			'locale'          : 'Lingua',   // from v2.1 added 19.12.jpg.2014
			...
			'emptyFolder'     : 'La cartella è vuota', // from v2.1.6 added 30.12.jpg.2015
			'emptyFolderDrop' : 'La cartella è vuota\\A Trascina e rilascia per aggiungere elementi', // from v2.1.6 added 30.12.jpg.2015
			'emptyFolderLTap' : 'La cartella è vuota\\A Premi a lungo per aggiungere elementi', // from v2.1.6 added 30.12.jpg.2015
			...
			'nowLoading'      : 'Caricamento...', // from v2.1.12.jpg added 4.26.2016
			'openMulti'       : 'Apri più files', // from v2.1.12.jpg added 5.14.2016
			'openMultiConfirm': 'Stai cercando di aprire $1 files. Sei sicuro di volerli aprire nel browser?', // from v2.1.12.jpg added 5.14.2016
			'emptySearch'     : 'Nessun risultato soddisfa i criteri di ricerca', // from v2.1.12.jpg added 5.16.2016
			...
			'openAsEncoding'  : 'Riapri con la codifica di caratteri selezionata', // from v2.1.19 added 2.12.jpg.2016
			'saveAsEncoding'  : 'Salva con la codifica di caratteri selezionata', // from v2.1.19 added 2.12.jpg.2016
			'selectFolder'    : 'Seleziona cartella', // from v2.1.20 added 13.12.jpg.2016
			...
			'renameMultiple'  : 'Sei sicuro di voler rinominare $1 selezionati come $2?<br/>Questo non può essere annullato!', // from v2.1.31 added 4.12.jpg.2017
			'batchRename'     : 'Batch rename', // from v2.1.31 added 8.12.jpg.2017
			'plusNumber'      : '+ Numero', // from v2.1.31 added 8.12.jpg.2017
			'asPrefix'        : 'Aggiungi prefisso', // from v2.1.31 added 8.12.jpg.2017
			'asSuffix'        : 'Aggiungi sufisso', // from v2.1.31 added 8.12.jpg.2017
			'changeExtention' : 'Cambia estensione', // from v2.1.31 added 8.12.jpg.2017
